...
const (
	...
	// DC:
	credAttrApiKey = "api-key"
	credAttrVirtDc = "virtual-datacenter"
)
...
func (environProviderCredentials) CredentialSchemas() map[cloud.AuthType]cloud.CredentialSchema {
	return map[cloud.AuthType]cloud.CredentialSchema{
		cloud.AccessKeyAuthType: {{
			credAttrApiKey, cloud.CredentialAttr{Description: "Danube Cloud user API key"},
		}, {
			credAttrVirtDc, cloud.CredentialAttr{
				Description: "Danube Cloud existing virtual datacenter",
				//Optional:    true,
			},
		}},
